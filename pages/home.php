...
<head>
    ...
    <title>Peoples Bank - Putting fun in funds since 1969</title>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-12 col-md-8 text-center">
                    <p class="text-center section-subtitle">
                        ...
                        and join the financial fiesta at peoples Bank! Where your hard-earned moolah gets more action
            ...
            <div class="row col-12 justify-content-center text-center text-uppercase" id="service-list">
                ...
                <div class="col-7 col-md-2 mb-4">
                    ...
                    <div class="d-flex justify-content-between ">
                        <a href="#" class="no-underline">
                            <p class="mt-3">vehicle <br>Auto Loan</p>
                        </a>
                        <a href="#" class="no-underline"> <img src="../assets/img/arrow_right.svg" alt="" height="35px"
                                class="mt-4">
                        </a>
    ...
    <footer id="contact">
        <div class="container pt-5 pb-3">
            <div class="row">
                <div class="col-lg-3">
                    <h5>About</h5>
                    <p>peoples Bank was founded by the one and only, Faizan Ahmad, a financial wizard with a passion
                        for puns.</p>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a href="#"><i class="fab fa-facebook fa-lg"
                                    id="icon-awesome"></i></a></li>
